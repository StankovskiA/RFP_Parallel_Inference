...
def get_latest_versions(main_folder_path):
    ...
    pdf_paths = [os.path.join(folder_path.replace(main_folder_path, ""), folder_path.replace(main_folder_path, "").split('/')[1]+ ".pdf") for folder_path, _ in latest_versions.items()]
